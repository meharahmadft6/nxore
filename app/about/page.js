...
import { ChevronDown, Users, Target, Heart, Zap, Code, Video, Phone, Award, TrendingUp, Globe, Star } from 'lucide-react';
...
export default function About() {
  ...
  const stats = [
    ...
    { number: "50+", label: "Happy Clients", icon: <Heart className="w-8 h-8" /> },
  ...
  const values = [
    {
      title: "Innovation",
      description: "We constantly push boundaries and explore cutting-edge technologies to deliver revolutionary solutions.",
      icon: <Zap className="w-8 h-8" />,
      color: "from-yellow-400 to-orange-500"
    },
    {
      title: "Excellence",
      description: "We strive for perfection in every line of code, every design element, and every client interaction.",
      icon: <Target className="w-8 h-8" />,
      color: "from-blue-400 to-indigo-500"
    },
    {
      title: "Collaboration",
      description: "We believe in the power of teamwork and close partnership with our clients to achieve extraordinary results.",
  ...
  return (
    <>
      ...
      <div style={{ display: 'none' }}>
        ...
        <meta name="description" content="Discover Nxore's expert team of developers, project managers, and creative professionals. We deliver innovative digital solutions including web development, mobile apps, and video production." />
        <meta name="keywords" content="Nxore, digital solutions, web development, mobile apps, MERN stack, video editing, project management, DevOps" />
      </div>
            ...
            <div className="text-center">
              <div className="animate-fade-in-up">
                ...
                <p className="text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12 animate-fade-in-up animation-delay-200">
                  ...
                  <span className="text-purple-600 font-semibold"> creative solutions</span>.
                </p>
              </div>
              ...
              <div className="flex justify-center animate-fade-in-up animation-delay-400">
                <div className="flex items-center space-x-4 bg-white/70 backdrop-blur-sm rounded-full px-8 py-4 shadow-lg">
                  ...
                  <span className="text-gray-600 font-medium">Meet our amazing team</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Driven by passion, guided by purpose, committed to excellence in everything we do.
              </p>
            </div>
                  ...
                  <>
                    <div className="animate-fade-in-up">
                      ...
                      <p className="text-lg text-gray-600 leading-relaxed">
                        We believe that every business deserves access to world-class digital tools and expertise, regardless of their size or industry.
                      </p>
                    </div>
                      ...
                      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white transform hover:scale-105 transition-transform duration-300 shadow-2xl">
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-lg leading-relaxed">
                            Transforming businesses across the globe with cutting-edge digital solutions.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {activeTab === 'vision' && (
                  <>
                    <div className="animate-fade-in-up">
                      ...
                      <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                        To be the leading digital partner for businesses worldwide, known for our innovative solutions, exceptional service, and commitment to client success.
                      </p>
                      <p className="text-lg text-gray-600 leading-relaxed">
                        We envision a future where technology seamlessly integrates with business needs to create extraordinary digital experiences.
                      </p>
                    </div>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 text-white transform hover:scale-105 transition-transform duration-300 shadow-2xl">
                        ...
                        <div className="relative z-10">
                          ...
                          <h4 className="text-2xl font-bold mb-4">Future Forward</h4>
                          <p className="text-lg leading-relaxed">
        ...
        <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Numbers that speak for our dedication and success</p>
            </div>
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div className="text-4xl font-bold text-gray-900 mb-2">
                      {stat.number.includes('+') ? `${statCounts[index][0]}+` : stat.number.includes('%') ? `${statCounts[index][0]}%` : statCounts[index][0]}
                    </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Let&apos;s collaborate and bring your digital vision to life with our expert team and cutting-edge solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="bg-white text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-colors duration-300 shadow-lg">
                Start Your Project
              </a>
              <a href="/contact" className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-300">
                Schedule a Call
              </a>
            </div>
          </div>
